...
public class WelcomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String collegeName = getInitParameter("collegeName");
        ...
        out.println("        .grid { display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; text-align: left; }");
        ...
        out.println("        .back-link { display: inline-block; margin-top: 1.5rem; color: var(--text-dim); text-decoration: none; font-size: 0.875rem; transition: color 0.2s; }");
        out.println("        .back-link:hover { color: var(--accent); }");
        out.println("    </style>");
        out.println("</head>");
        out.println("<body>");
        out.println("    <div class='glass-card'>");
        out.println("        <span class='welcome-badge'>System Active</span>");
        out.println("        <h1>Welcome Portal</h1>");
        out.println("        <p class='college'>" + (collegeName != null ? collegeName : "Academic Institution") + "</p>");
        out.println("        <div class='grid'>");
        out.println("            <div class='item full-width'>");
        out.println("                <div class='label'>Authorized Administrator</div>");
        out.println("                <div class='value'>" + (adminName != null ? adminName : "System Admin") + "</div>");
        out.println("            </div>");
        out.println("            <div class='item full-width'>");
